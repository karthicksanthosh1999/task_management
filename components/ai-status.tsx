    ...
    useEffect(() => {
        const checkAI = async () => {
            try {
                ...
                setStatus("inactive"); // Can't connect → AI not running
            }
        };
